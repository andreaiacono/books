...
export const SUBJECT_KEYWORDS = {
  ...
  'Biology':         ['biology','botany','zoology','ecology','genetics','microbiology','evolution','life science','organism',
                      'biologia','botanica','zoologia','ecologia','genetica','microbiologia','evoluzione','scienze della vita','organismo'],
  ...
  'Philosophy':      ['philosophy','ethics','metaphysics','epistemology','logic','phenomenology','aesthetics','moral',
                      'filosofia','etica','metafisica','epistemologia','logica','fenomenologia','estetica','morale'],
  ...
  'Politics':        ['politics','political','government','democracy','law','diplomacy','international relations','policy','justice',
                      'politica','politico','governo','democrazia','legge','diplomazia','relazioni internazionali','giustizia','diritto'],
  ...
  'Science':         ['science','scientific','biology','geology','earth science',
                      'scienza','scientifico','biologia','geologia','scienze della terra'],
